...
We have presented the design of a novel, portable foreign function interface
for web-targeting Haskell dialects. While designed for the web space, said
interface is also implementable for a wide range of popular dynamic target
languages. We have also given a number of
