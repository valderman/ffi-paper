...
the restriction of our \lstinline!ffi_safe! function to only accept statically
...
range of host environments, we have yet to implement this interface for a
non-JavaScript environment.
