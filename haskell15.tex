...
With this background, we believe that, in the domain of hosted Haskell
dialects, we can improve on the vanilla FFI. More specifically, we would like
a high level foreign function interface to espouse the following qualities:
