...
\item
  ...
  for your types, either automatically using the generic default instances
  given in section \ref{sec:default-instances} as showcased by our motivating
  example in figure \ref{lst:good-ffi},
  or by defining them manually with the dictionary
